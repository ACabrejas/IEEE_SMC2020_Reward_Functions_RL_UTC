...
\title{Assessment of Reward Functions for Reinforcement Learning Vehicular Traffic Signal Control Under Real-World Limitations\\
...
\begin{IEEEkeywords}
Reinforcement Learning, Urban Traffic Control, Reward Function
\end{IEEEkeywords}
